...
type UserService interface {
	...
	GetUserByID(ctx context.Context, in *User, opts ...client.CallOption) (*Response, error)
...
func (c *userService) GetUserByID(ctx context.Context, in *User, opts ...client.CallOption) (*Response, error) {
...
func RegisterUserServiceHandler(s server.Server, hdlr UserServiceHandler, opts ...server.HandlerOption) error {
	type userService interface {
		...
		GetUserByID(ctx context.Context, in *User, out *Response) error
...
func (h *userServiceHandler) GetUserByID(ctx context.Context, in *User, out *Response) error {
